...
export function ProjectTasksPanel({ projectId }: ProjectTasksPanelProps) {
  ...
  const [newTaskStatus, setNewTaskStatus] = useState<Task['status']>('InProgress');
      ...
      <div>
        ...
        {showAddForm && (
          <div className="mb-3 p-3 border rounded-lg bg-muted/30 space-y-2">
            ...
            <div>
              <Label htmlFor="taskDesc" className="text-xs">
                Description
              </Label>
              <Input
                id="taskDesc"
            ...
            {/* Status is auto-set to InProgress by the server on creation */}
        ...
        <div className="space-y-0.5">
              ...
              {editingTaskId === task.id ? (
                ...
                <div className="p-2 rounded-md border bg-muted/30 space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(v) => setEditData({ ...editData, status: v as Task['status'] })}
                  >
          ...
          {filteredTasks.length === 0 && searchQuery && (
            <div className="text-center py-4 text-sm text-muted-foreground">No tasks match"{searchQuery}"</div>
          )}
