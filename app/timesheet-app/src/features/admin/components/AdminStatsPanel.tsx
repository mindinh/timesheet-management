    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between bg-card p-4 rounded-xl border border-border shadow-sm">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="font-semibold text-foreground w-32 text-center">{format(currentDate, 'MMMM yyyy')}</span>
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card className="shadow-sm border-border flex flex-col h-full">
            <CardHeader className="bg-muted/30 border-b border-border py-4">
              ...
              <CardDescription>
                Active users who haven't logged any hours for {format(currentDate, 'MMMM yyyy')}
              </CardDescription>
            </CardHeader>
                ...
                <ul className="divide-y divide-border/50">
                  {stats.overtimeUsers.map((ot) => (
                    ...
                    >
                      ...
                      <div className="text-sm font-bold text-emerald-600 dark:text-emerald-400 shrink-0 bg-emerald-50 dark:bg-emerald-900/20 px-2.5 py-1 rounded border border-emerald-200 dark:border-emerald-800/30">
                            ...
                            className={`text-[10px] px-1.5 py-0.5 rounded uppercase font-semibold ${
                              activity.action === 'Created'
                                ...
                                : activity.action === 'Reopened'
                                  ...
                                  : activity.action === 'Finished' || activity.action === 'Approved'
