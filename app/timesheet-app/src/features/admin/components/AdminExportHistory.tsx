                ...
                logs.map((log) => (
                  <TableRow key={log.ID}>
                    ...
                    <TableCell className="text-right">
                      <Button variant="outline" size="sm" className="gap-2" onClick={() => handleOpenEmailDialog(log)}>
      ...
      <Dialog open={isEmailModalOpen} onOpenChange={setIsEmailModalOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              This will send the export file ({selectedExport?.fromDate} to {selectedExport?.toDate}) to the German
              client.
            </DialogDescription>
          </DialogHeader>
