...
import { SortDialog, type SortOption, type SortByOption, ColumnSettingsDialog, type ColumnSetting } from '@/shared/components/dialogs'
...
export default function AdminBatchPage() {
    ...
    const filterConfig: FilterFieldConfig[] = useMemo(() => {
        const teamLeadOptions = Array.from(new Map(
            batches
        ...
        },
        {
            ...
            render: (_, batch) => (
                <span className={cn(
                    ...
                    batch.status === 'Pending' ? 'bg-amber-500/10 text-amber-500 border border-amber-500/20' :
                        batch.status === 'Done' ? 'bg-green-500/10 text-green-500 border border-green-500/20' :
    ...
    return (
        <div className="flex flex-col h-full space-y-0">
            ...
            {/* Toolbar */}
            <div className="sticky top-0 z-30 pt-4 pb-4 px-4 bg-background">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <h2 className="text-lg font-semibold text-foreground flex items-center gap-2">
                        Timesheet Batches
                        <span className="text-primary font-normal text-muted-foreground ml-1">
            ...
            {/* Data Table */}
            <div className="flex-1 px-4 pb-4 h-[calc(100vh-280px)]">
