    ...
    const cards = [
        {
            ...
            bg: 'bg-[color:var(--sap-informative)]/10',
        ...
        },
        {
            ...
            bg: 'bg-[color:var(--sap-positive)]/10',
        },
        {
            title: 'Pending Approvals',
            value: pendingCount,
            icon: ClipboardCheck,
            color: pendingCount > 0 ? 'text-[color:var(--sap-critical)]' : 'text-[color:var(--sap-positive)]',
            bg: pendingCount > 0 ? 'bg-[color:var(--sap-critical)]/10' : 'bg-[color:var(--sap-positive)]/10',
