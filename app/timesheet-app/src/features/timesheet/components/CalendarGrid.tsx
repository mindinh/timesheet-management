            ...
            >
                ...
                {dailyTotal > 0 && (
                  <span
                    className={cn(
                      ...
                      dailyTotal >= 8 ? 'bg-success-bg text-success' : 'bg-warning-bg text-warning',
                      dailyTotal > 24 && 'bg-error-bg text-error'
                    )}
                  >
                    {dailyTotal}h
                  </span>
              ...
              {!isWeekend && dailyTotal === 0 && isCurrentMonth && day < new Date() && (
                <div className="mt-4 flex justify-center">
                  <span className="text-xs text-destructive/50">Missing</span>
                </div>
              )}
            </div>
          );
