...
export async function getEntries(month: number, year: number, userId: string): Promise<TimesheetEntry[]> {
...
export async function updateEntry(id: string, entry: Partial<TimesheetEntry>): Promise<TimesheetEntry> {
...
export async function bulkSaveEntries(entries: (TimesheetEntry & { timesheetId: string })[]): Promise<void> {
