...
export function SortDialog({ open, onClose, onApply, sortByOptions, defaultSort }: SortDialogProps) {
      ...
      <DialogContent hideCloseButton className="sm:max-w-[400px] flex flex-col p-0 gap-0 overflow-hidden max-h-[80vh]">
        ...
        <div className="overflow-y-auto flex-1 pb-4 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-border [&::-webkit-scrollbar-thumb]:rounded-full">
            ...
            >
              ...
              >
                <RadioGroupItem
                  value="ascending"
                  id="order-ascending"
                  className={sortOrder === 'ascending' ? 'border-destructive text-destructive' : ''}
                />
              ...
              >
                <RadioGroupItem
                  value="descending"
                  id="order-descending"
                  className={sortOrder === 'descending' ? 'border-destructive text-destructive' : ''}
                />
          ...
          <div>
            ...
            <RadioGroup value={sortBy} onValueChange={setSortBy} className="gap-0 w-full">
              {sortByOptions.map((option) => (
                ...
                >
                  <RadioGroupItem
                    ...
                    className={sortBy === option.key ? 'border-destructive text-destructive' : ''}
                  />
