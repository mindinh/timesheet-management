 ...
 */
export function DateRangeFilter({ config, value, onChange }: FilterComponentProps<DateRangeFilterConfig>) {
  ...
  const dateRange: DateRange = (value as DateRange) || { from: undefined, to: undefined };
  ...
  const placeholder = config.placeholder ? t(config.placeholder, config.placeholder) : 'e.g. Dec 22, 2026-Dec 23, 2026';
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      <PopoverTrigger asChild>
        ...
        <div
          className={cn(
            'h-9 w-full flex items-center border-2 rounded-md bg-card cursor-pointer transition-all',
            isOpen
        ...
        >
          <input
            ...
            className="flex-1 h-full px-3 text-sm bg-transparent outline-none border-none"
          ...
          {viewMode === 'days' ? (
            ...
            <>
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-sm font-medium text-primary">{viewDate.getFullYear()}</span>
            ...
            <>
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-sm font-medium text-primary underline">{getYearRange()}</span>
