    ...
    <div>
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogTrigger asChild>
          <div className="min-h-9 w-full flex flex-wrap items-center gap-1 px-3 py-1.5 border-2 rounded-md bg-input-background cursor-pointer transition-all border-[var(--input-border)] hover:border-[var(--input-border-hover)]">
          ...
          <div className="space-y-4">
            ...
            <div className="max-h-64 overflow-y-auto border rounded-md">
              {isLoading ? (
                ...
                <div className="text-center py-8 text-muted-foreground">{t('common.noResults', 'No items found')}</div>
              ) : (
                <div className="divide-y">
                  {items.map((item) => {
                    ...
                    return (
                      ...
                      >
                        <Checkbox checked={isSelected} onCheckedChange={() => handleToggleItem(item)} />
