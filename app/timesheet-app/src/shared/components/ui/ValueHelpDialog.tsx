        ...
        <div>
            <Dialog open={isOpen} onOpenChange={setIsOpen}>
                <DialogTrigger asChild>
                    <div
                        className="min-h-9 w-full flex flex-wrap items-center gap-1 px-3 py-1.5 border-2 rounded-md bg-input-background cursor-pointer transition-all border-[var(--input-border)] hover:border-[var(--input-border-hover)]"
                    >
