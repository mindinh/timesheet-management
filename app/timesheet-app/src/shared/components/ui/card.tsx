...
const CardTitle = React.forwardRef<HTMLHeadingElement, React.ComponentProps<'h4'>>(({ className, ...props }, ref) => (
...
const CardFooter = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn('flex items-center px-6 pb-6 [.border-t]:pt-6', className)} {...props} />
));
